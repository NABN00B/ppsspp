...
void GameBrowser::Refresh() {
	...
	if (DisplayTopBar()) {
		...
		if (*gridStyle_) {
			gameList_ = new UI::GridLayoutList(UI::GridLayoutSettings(150*g_Config.fGameGridScale, 85*g_Config.fGameGridScale), new GridLayoutParams(FILL_PARENT, WRAP_CONTENT, Margins(10, 0, 0, 0)));
		} else {
